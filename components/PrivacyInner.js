...
const PrivacyInner = () => {
  return (
    <View style={styles.inner}>
      ...
      <LI text={`단체명, 대표자·담당자 정보(이름, 이메일, 전화번호, 직책)`} />
      ...
      <Text style={styles.content}>4. 개인정보의 제3자 제공 및 처리위탁</Text>
      <Text style={styles.content2}>
        회사는 관련법 및 훠원의 동의가 없는 한, 훠원의 개인정보를 제3자에게 절대
        제공하지 않습니다. 단, 회사는 보안성 높은 서비스 제공을 위하여, 신뢰도가
        검증된 아래 회사에 개인정보 관련업무 처리를 위탁할 수 있습니다. 이 경우
        회사는 훠원에게 위탁을 받는 자와 업무의 내용을 사전에 알리고 동의를
        받습니다, 위탁을 받는 자 또는 업무의 내용이 변경될 경우에도 같습니다.
      </Text>
      <Text style={styles.content2}>
        회사는 정보통신 서비스의 제공에 관한 계약을 이행하고 회원의 편의 증진
      ...
      <Text style={styles.content2}>
        2. 가입 및 학교 인증 시 수집된 개인정보 등 개인 프로필 정보 : 탈퇴 시
        즉시 파기
      </Text>
      <Text style={styles.content2}>
      ...
      <Text style={styles.content2}>
        ※ 위 항에도 불구하고 법령에 의해 개인정보를 보관할 경우, 해당 법령에서
        정한 최대 기간만큼 저장합니다.
      </Text>
      <Text style={styles.content2}>
      ...
      <Text style={styles.content2}>
        ...
        계정으로 전환됩니다. 휴면 계정이 로그인에 성공할 경우, 휴면 상태가 즉시
        해제되어 모든 서비스를 이용할 수 있습니다. 휴면 계정 전환 이후에도 3년
        간 로그인을 하지 않을 경우, 해당 계정은 영구 삭제됩니다.
      </Text>
      <Text style={styles.content2}>
        ※ 학교 인증 시, 위조·도용 피해를 방지하기 위해 학교 웹메일 주소를 사용자
        데이터와 분리하여 1년간 보관합니다.
      </Text>
      <Text style={styles.content2}>
        ※ 부정행위 시, 제재를 위해 IP 주소 및 학교, 학교 웹메일 주소, 연계정보를
        최대 1년 간 보관합니다. 단, 커뮤니티 및 채팅 내역 유출, 타 회원 정보
        유출, 시스템 해킹, 학교 인증자료 위·변조, 계정 탈취·판매 등의 중대한
        부정행위로 서비스에 피해가 발생할 수 있다고 판단될 경우, 추가 피해
        방지를 위해 이를 5년 간 보관합니다.
      </Text>
      <Text style={styles.content}>6. 정보 주체의 권리, 의무 및 행사</Text>
      <Text style={styles.content2}>
        회원은 언제든지 [프로필 수정]을 통해 자신의 개인정보를 조회하거나 수정,
        삭제, 탈퇴를 할 수 있습니다.
      </Text>
      ...
      <Text style={styles.content}>8. 개인정보에 관한 책임자 및 서비스</Text>
      <Text style={styles.content2}>
        회사는 회원의 개인정보를 최선으로 보호하고 관련된 불만을 처리하기 위해
        권리침해신고센터를 운영하고 있습니다.
      </Text>
      <Text style={styles.content2}>
      ...
      <Text style={styles.content2}>
        ※ 서비스 이용, 접근 제한 등의 문의는 권리침해신고센터를 통해 처리되지
        않습니다. 해당 문의는 [문의하기] 를 통해 전달해주시기 바랍니다
      </Text>
      <Text style={styles.content2}>
      ...
      <Text style={styles.content2}>
        ...
        항목, 이용 목적의 변경 등과 같이 회원 관리의 중대한 변경이 발생할 때에는
        최소 30일 전에 공지하거나, 동의를 다시 받도록 하겠습니다.
      </Text>
    </View>
  );
};
