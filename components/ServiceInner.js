  ...
  return (
    <View style={styles.inner}>
      ...
      <Text style={styles.content}>
        ...
        거부 의사를 표현할 수 있습니다. 단, 30일 내에 거부 의사를 표현하지 않을
      ...
      <Text style={styles.content}>1. 회사는 다음 서비스를 제공합니다.</Text>
      ...
      <Text style={styles.content}>
        1. 캠퍼스데이트는 대학교 웹메일이 유효한지 아닌지를 검증하여 대학생으로
        인증된 이용자에 한해 이용할 수 있는 소개팅 서비스입니다. 해당 대학교의
        학생이 아닌 이용자와 만 18세 미만의 이용자는 서비스를 이용하거나
        회원가입을 할 수 없으며, 그럼에도 불구하고 성립된 회원가입은 무효로
        간주합니다.
      </Text>
      <Text style={styles.content}>
      ...
      <Text style={styles.content}>
        1. 회사는 유용하고 편리한 서비스를 제공하기 위해, 2022년부터 서비스 및
        서비스 내부의 기능(매칭하기, 내 연인 찾기, 후기 등)의 체계와 다양한
        기능(매칭 알고리즘, 검색 기능 등)을 직접 설계 및 운영하고 있는
        데이터베이스 제작자에 해당합니다. 회사는 저작권법에 따라 데이터베이스
        제작자는 복제권 및 전송권을 포함한 데이터베이스 전부에 대한 권리를
        가지고 있으며, 이는 법률에 따라 보호를 받는 대상입니다. 그러므로
        이용자는 데이터베이스 제작자인 회사의 승인 없이 데이터베이스의 전부 또는
      ...
      <Text style={styles.content}>
        ...
        수 있습니다. 이 경우, 회원의 개인정보는 제공하지 않습니다. 다만, 사진의
        경우 모자이크 내지 블러처리, 이름의 경우 성(金)만 표기 하고 나머지는 *로
        가려 처리한 후 일부 개인정보를 제공할 수도 있습니다.
      </Text>
      <Text style={styles.content}>
        3. 회사는 전항 이외의 방법으로 회원의 게시물을 이용할 경우, 서비스 내부
        알림 수단과 회원의 연락처를 이용하여 회원의 동의를 받아야 합니다.
      </Text>
      ...
      <OL2 text={`타인의 개인정보 및 계정을 수집, 저장, 공개, 이용하는 행위`} />
      <OL2 text={`자신과 타인의 개인정보를 제3자에게 공개, 양도하는 행위`} />
      ...
      />
      <OL2 text={`회사 및 타인의 명예를 손상시키거나 업무를 방해하는 행위`} />
      <OL2
      ...
      <Text style={styles.content}>
        이 약관에도 불구하고 다른 약관이나 서비스 이용 중 안내 문구 등으로 달리
